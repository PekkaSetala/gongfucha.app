...
export const brewTips: BrewTip[] = [
  ...
  { id: "s12", text: "Aged white develops jujube and wood notes that young white never shows. Notice how different it is from fresh white.", category: "sensory", teaTypes: ["aged-white"], infusionRange: [2, 6] },
  ...
  { id: "s14", text: "In high-mountain oolong, look for a cooling sensation at the back of the throat. That's the elevation talking.", category: "sensory", teaTypes: ["light-oolong"], infusionRange: [2, 6] },
  { id: "s15", text: "Roasted oolong should taste like charcoal transformed into something sweet — not like burnt toast. The roast should enhance, not dominate.", category: "sensory", teaTypes: ["dark-oolong"], infusionRange: [2, 5] },
  { id: "s16", text: "Young sheng often starts with a sharp bitterness that transforms in the mouth. Wait for the shift — that's the character of the tea.", category: "sensory", teaTypes: ["sheng"], infusionRange: [1, 4] },
  { id: "s17", text: "Shou pu-erh should taste earthy, not muddy. If it's clean and smooth with notes of dark chocolate or dried fruit, the fermentation was done well.", category: "sensory", teaTypes: ["shou"], infusionRange: [2, 6] },
  ...
  { id: "t06", text: "Shou still tasting muddy after the rinses? Some cakes need a third rinse — or just accept that the first steep is a warmup.", category: "troubleshooting", teaTypes: ["shou"], infusionRange: [1, 3] },
  { id: "t07", text: "If the roast flavor in your yancha is overpowering, let it rest a few months. Fresh-roasted oolong often needs time to settle.", category: "troubleshooting", teaTypes: ["dark-oolong"], infusionRange: [1, 4] },
  ...
  { id: "t10", text: "White tea fading fast? That's normal — white tea gives its best in the first few steeps. A short session isn't a failure.", category: "troubleshooting", teaTypes: ["fresh-white"], infusionRange: [3, 6] },
  { id: "t11", text: "If your sheng is painfully bitter and won't transform, the tea may be young plantation material. Shorter steeps help, but there are limits.", category: "troubleshooting", teaTypes: ["sheng"], infusionRange: [1, 4] },
  ...
  { id: "v03", text: "Shā gǎn (杀感) — 'killing sensation.' The sharp astringency of young sheng pu-erh that grips the throat. It mellows with age.", category: "vocabulary", teaTypes: ["sheng"], infusionRange: [1, 5] },
  { id: "v04", text: "Yán yùn (岩韵) — 'rock rhyme.' The mineral, stony character unique to Wuyi yancha. It's what the cliffs leave in the leaf.", category: "vocabulary", teaTypes: ["dark-oolong"], infusionRange: [2, 6] },
  ...
  { id: "v07", text: "Duī wèi (堆味) — 'pile taste.' The earthy, sometimes fishy flavor in shou pu-erh from the fermentation process. Clears with rinses and age.", category: "vocabulary", teaTypes: ["shou"], infusionRange: [1, 3] },
  ...
  { id: "v09", text: "Chén xiāng (陈香) — 'aged aroma.' The distinctive scent of well-aged tea — camphor, dried fruit, old wood. It develops over years.", category: "vocabulary", teaTypes: ["sheng", "shou", "aged-white"], infusionRange: [1, 5] },
  ...
  { id: "v13", text: "Gāo xiāng (高香) — 'high fragrance.' The bright, lifted aroma typical of high-mountain oolongs and quality green teas.", category: "vocabulary", teaTypes: ["light-oolong", "green"], infusionRange: [1, 4] },
  ...
  { id: "v15", text: "Tián rùn (甜润) — 'sweet and moist.' A quality in tea where sweetness feels hydrating rather than cloying. Common in well-made black tea.", category: "vocabulary", teaTypes: ["black"], infusionRange: [2, 6] },
  ...
  { id: "h17", text: "Wuyi's yancha (rock tea) grows in the crevices of cliffs. The terroir — mineral soil, mist, and filtered light — defines the tea's character.", category: "historical", teaTypes: ["dark-oolong"], infusionRange: [1, 12] },
  ...
  { id: "c08", text: "Is the tea getting smoother? Roasted oolongs often need 2-3 steeps before the roast softens and the underlying sweetness emerges.", category: "comparison", teaTypes: ["dark-oolong"], infusionRange: [2, 5] },
  ...
  { id: "c10", text: "Has the astringency mellowed since the first steep? Sheng often transforms from sharp to sweet over the course of a session.", category: "comparison", teaTypes: ["sheng"], infusionRange: [2, 6] },
  ...
  { id: "c19", text: "Shou pu-erh often becomes sweeter and cleaner as the session goes on. The best cups may be ahead of you.", category: "comparison", teaTypes: ["shou"], infusionRange: [3, 6] },
  ...
  // ── Sensory: Tasting technique ──
  { id: "s23", text: "Take three sips from one cup — the first for aroma, the second for flavor, the third for aftertaste. The Chinese call it 三口 (sān kǒu), three mouths. Each one reveals a different layer.", category: "sensory", teaTypes: ["all"], infusionRange: [1, 8] },
  { id: "s24", text: "Smell the lid three times: right after pouring (hot aroma), a minute later (warm aroma), and when the cup is cool (cold aroma, 冷香 lěng xiāng). A good tea keeps giving on every pass.", category: "sensory", teaTypes: ["all"], infusionRange: [1, 6] },
  { id: "s25", text: "Try a small slurp — draw the tea in with air across the tongue. It aerates the liquor the way cupping does in coffee, and suddenly more flavor shows up.", category: "sensory", teaTypes: ["all"], infusionRange: [1, 8] },
  { id: "s26", text: "Let a sip sit on the back of the tongue for a beat before swallowing. That's where bitterness and the deeper notes live; the tip of the tongue only tells you about sweetness.", category: "sensory", teaTypes: ["all"], infusionRange: [1, 6] },
  { id: "s27", text: "After swallowing, close your mouth and breathe slowly for ten seconds. Notice what comes back — this is the 回味 (huí wèi), the returning taste. Strong teas keep speaking long after they're gone.", category: "sensory", teaTypes: ["all"], infusionRange: [2, 10] },
  { id: "s28", text: "Hold the cup under your nose and exhale gently into it, then inhale. Your breath warms the residual aroma and it blooms — a trick from Chaozhou tasters.", category: "sensory", teaTypes: ["all"], infusionRange: [1, 6] },
  { id: "s29", text: "Roll a small sip across the whole tongue before swallowing. Different zones pick up different qualities — sweetness at the tip, sourness at the sides, bitterness at the back, umami everywhere.", category: "sensory", teaTypes: ["all"], infusionRange: [1, 8] },
  { id: "s30", text: "Pay attention to 生津 (shēng jīn) — the moment your mouth starts producing saliva after a sip, especially under the tongue and along the cheeks. It's one of the clearest signs of a living tea.", category: "sensory", teaTypes: ["all"], infusionRange: [2, 8] },
  { id: "s31", text: "Between sips, rest and notice the 齿颊留香 (chǐ jiá liú xiāng) — the fragrance lingering between your teeth and cheeks. In classical tea writing this is considered as important as the flavor itself.", category: "sensory", teaTypes: ["all"], infusionRange: [2, 8] },
  { id: "s32", text: "Open the vessel and examine the wet leaves mid-session. Color, softness, unbroken stems — the leaf tells you about grade and craft as clearly as the liquor does.", category: "sensory", teaTypes: ["all"], infusionRange: [3, 8] },
  { id: "s33", text: "Smell the bottom of your empty cup after a sip — the 杯底香 (bēi dǐ xiāng), cup-bottom fragrance. Heavier aromatic compounds settle there and reveal themselves last.", category: "sensory", teaTypes: ["oolong", "black"], infusionRange: [1, 5] },
  { id: "s34", text: "After a hot sip, sip cool water and return to the tea. The palate resets and the tea's character comes through sharper — a trick for long sessions when your tongue starts to numb.", category: "sensory", teaTypes: ["all"], infusionRange: [4, 12] },
  { id: "s35", text: "With young sheng, watch for the 苦化甘 (kǔ huà gān) — bitterness transforming into sweetness inside your mouth. The speed and completeness of the turn tells you about the tea's material.", category: "sensory", teaTypes: ["sheng"], infusionRange: [1, 5] },
  { id: "s36", text: "Notice how cleanly the tea leaves your mouth. A good shou should finish soft and warm, with no lingering muddiness. If the finish is clean, the fermentation was handled well.", category: "sensory", teaTypes: ["shou"], infusionRange: [2, 8] },
  { id: "s37", text: "With high-mountain oolong, inhale sharply through pursed lips right after swallowing. A cooling, almost menthol sensation at the back of the throat — that's the elevation you paid for.", category: "sensory", teaTypes: ["light-oolong"], infusionRange: [2, 6] },
];
