...
export function SecondaryPaths({ onOpenAI, onOpenCustom }: SecondaryPathsProps) {
  return (
    <div className="px-5 pt-4 pb-2 flex flex-col gap-2">
      <button
        onClick={onOpenAI}
        className="flex items-center gap-3 px-4 py-3.5 rounded-[14px] border border-dashed border-border bg-transparent text-left hover-lift"
        style={{
      ...
      >
        ...
        <span className="flex-1 min-w-0">
          <span className="block text-[14px] font-[450] text-primary">
            Ask AI
          </span>
